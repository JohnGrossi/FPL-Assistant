...
async function fetchPlayerData() { 
    ...
    for (i = 0; i < players.elements.length; i++) {
        ...
        if( players.elements[i].second_name.isLatin() == false) {
            ...
            if (getPosition(players.elements[i].element_type) == 1) {

            } else if (getPosition(players.elements[i].element_type) == 2) {

            } else if (getPosition(players.elements[i].element_type) == 3) {

            } else if (getPosition(players.elements[i].element_type) == 4) {
                player.set(players.elements[i].second_name, {'team': getTeamName(players.elements[i].id), 'price': players.elements[i].now_cost, 'position': getPosition(players.elements[i].element_type), 'fitness': players.elements[i].chance_of_playing_this_round, 'pointsTotal': players.elements[i].total_points, 'goalsTotal': players.elements[i].goals_scored, 'assistTotal': players.elements[i].assists});
            }
...
function getFixture(homeScore, awayScore, was_home) {
